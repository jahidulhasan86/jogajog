...
export class ChatService {
	...
	public _messagesUnread = <BehaviorSubject<number>>new BehaviorSubject(0);
	...
	public playSound() {
		const mp3Source = '<source src="../../../../assets/sound/chat_tone.mp3" type="audio/mpeg">';
		const oggSource = '<source src="../../../../assets/sound/chat_tone.ogg" type="audio/ogg">';
		const embedSource = '<embed hidden="true" autostart="true" loop="false" src="../../../../assets/sound/chat_tone.mp3">';
